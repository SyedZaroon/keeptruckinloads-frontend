  ...
  return (
    <div className="flex items-center justify-between px-3 relative z-50 md:my-0 my-4">
      ...
      <div className="md:flex hidden items-center gap-6">
        <Link to="/" className="text-white border-t-2 border-transparent hover:border-t-2 hover:border-white">Home</Link>
        <Link to="/aboutus" className="text-white border-t-2 border-transparent hover:border-t-2 hover:border-white">About Us</Link>
        <Link to="/services" className="text-white border-t-2 border-transparent hover:border-t-2 hover:border-white">Services</Link>
        <Link to="/testimonials" className="text-white border-t-2 border-transparent hover:border-t-2 hover:border-white">Testimonials</Link>
        <Link to="/contact" className="text-white border-t-2 border-transparent hover:border-t-2 hover:border-white">Contact Us</Link>
      </div>
