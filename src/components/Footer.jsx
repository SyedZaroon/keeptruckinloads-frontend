...
import { FaBars, FaClock, FaEnvelope, FaFacebookF, FaGooglePlusG, FaInstagram, FaPhone, FaWhatsapp } from 'react-icons/fa'
    ...
    >
          ...
          <div>
            <form action="" className='flex flex-col gap-7'>
              <div className='flex gap-3'>
                <input type='name' placeholder='Name' className=' bg-transparent focus:outline-none border-b-2 border-dotted text-white ' />
                <input type='email' placeholder='Email' className=' bg-transparent focus:outline-none border-b-2 border-dotted text-white ' />
              </div>
              <div className='flex gap-3'>
                <input type='tel' placeholder='Phone' className=' bg-transparent focus:outline-none border-b-2 border-dotted text-white ' />
                <input type='text' placeholder='Company' className=' bg-transparent focus:outline-none border-b-2 border-dotted text-white ' />
              </div>
              <div className=''>
              ...
              <textarea name="Message" id="" rows={4} placeholder='Message' className='bg-transparent focus:outline-none border-b-2 border-dotted text-white w-full' ></textarea>
              <div className='flex items-center gap-4'>
                <input type="checkbox" />
                <a href="" className='text-white hover:[ decoration-1 underline] ' >I have read and understand the privacy policy.</a>
              </div>
              <input type='sumbit' value='Submit' className='bg-[#006CB7] text-white text-center p-2 hover:bg-[#005D9E] cursor-pointer ' />
      ...
      <div className='bg-[#3A3C3B] relative z-10 p-4 flex justify-around items-center  '>
        <div className='flex gap-2 text-white'>
          ...
          <a href='' className=' border-b-2 border-b-transparent    border-white hover:border-b-2 hover:border-white ' >| Legal Notice</a>
          <a href='' className=' border-b-2 border-b-transparent  border-white hover:border-b-2 hover:border-white ' >| Privacy</a>
        </div>
