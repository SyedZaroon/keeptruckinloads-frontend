  ...
  return (
    <>
      ...
      <section className="text-center py-[70px] px-6 bg-white">
        ...
        <p className="my-8 text-[#5a5c5b]  max-w-[850px] text-start mx-auto">
        ...
        {/* Responsive Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-12 px-4 sm:px-12 md:px-20 lg:px-56">
          {/* Card 1 */}
          <div className=" relative border-[3px] border-[#006cb7] border-double p-4 shadow-md bg-white ">
           ...
           <div className="py-6">
            ...
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 " >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="259 -787 480 875" data-icon="ico-flash" className="w-16 h-16 p-1 fill-[#006CB7] bg-white " preserveAspectRatio="xMidYMid"><path d="M484 -391.7h256.4C618.8 -230.9 498.4 -71.7 378 87.5l-1.8 -1C419.7 -32.9 463.3 -152.2 507.6 -274c-82.9 3.7 -163.9 7.3 -248.1 11 123.4 -176.3 245.4 -350.4 367.4 -524.5l2.3 1C580.9 -655.5 532.7 -524.4 484 -391.7z"></path></svg>
            </div>
